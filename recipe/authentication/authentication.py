...
def register():
    ...
    if form.validate_on_submit():
        try:
            ...
            user_name_not_unique = 'Your username is already taken - please choose another'
...
def login():
    ...
    if form.validate_on_submit():
        try:
            ...
            user_name_not_recognised = 'User name not recognised - please choose another'

        except services.AuthenticationException:
            # Authentication failed, set a suitable error message.
            password_does_not_match_user_name = 'Password does not match existing username - please check and try again'
